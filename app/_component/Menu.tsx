                ...
                <Card className="p-5 ">
                    <ul className="flex items-center gap-2 justify-around">
                        ...
                        className={cn(buttonVariants({variant:"outline"} ), "size-6 p-0")} >
                            <GitHubIcons size={100} className="text-white hover:text-green4 transition-colors">
                        ...
                        className={cn(buttonVariants({variant:"outline"} ), "size-6 p-0")} >
                            <FbIcon size={100} className="text-white hover:text-green4 transition-colors">
                        ...
                        className={cn(buttonVariants({variant:"outline"} ), "size-6 p-0")} >
                            <LinkedinIcon size={100} className="text-white hover:text-green4 transition-colors">
                        ...
                        className={cn(buttonVariants({variant:"outline"} ), "size-6 p-0")} >
                            <MailIcon size={100} className="text-white hover:text-green4 transition-colors">
